...
exports.originService = {
    ...
    async verify(params) {
        const body = {
            ...
            platform_id: config_1.config.origin.platformId,
        };
        const res = await fetch(`${config_1.config.origin.ledgerUrl}/v1/ledger/verify`, {
            method: 'POST',
     ...
     */
    async keyStatus(creatorId, keyId) {
        const url = new URL(`${config_1.config.origin.ledgerUrl}/v1/ledger/key-status`);
...
//# sourceMappingURL=originService.js.map